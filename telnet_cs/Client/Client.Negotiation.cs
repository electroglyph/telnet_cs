...
public partial class Client
{
    ...
    {
        return SendRequestAsync(ResolveEnableRequest(Negotiation, telnetOption), telnetOption, cancellationToken);
    }
    ...
    {
        return SendRequestAsync(ResolveEnableRequest(Negotiation, Options.TimingMark), Options.TimingMark, cancellationToken);
    }
