...
/// </summary>
public abstract partial class TelnetSessionBase
{
    /// <summary>
    /// The send rate limit.
    /// </summary>
    ...
    /// <summary>
    /// Initialises a new instance of the <see cref="TelnetSessionBase"/> class.
    /// </summary>
    /// <param name="byteStream">The byte stream.</param>
    /// <param name="token">The token.</param>
    protected TelnetSessionBase(IByteStream byteStream, CancellationToken token)
    {
