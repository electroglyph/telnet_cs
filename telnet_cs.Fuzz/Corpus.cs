...
internal static class Corpus
{
    ...
    [
        ...
        Frame(201, Ascii("Char.Vitals {\"hp\":100,\"stats\":{\"str\":18,\"dex\":14},\"flags\":[true,false,null]}")),
        Frame(201, Ascii("Room.Info {\"exits\":[\"n\",\"s\"],\"id\":42}")),
        Frame(201, Ascii("Room.Info [1,2]")),
        ...
        Frame(70, [1, .. Ascii("NAME"), 2, .. Ascii("a"), 2, .. Ascii("b")]),
        Frame(93, [.. Ascii("zmp.ident"), 0, .. Ascii("mud"), 0, .. Ascii("1.0"), 0]),
        Frame(200, Ascii("Room.Exits ne,nw")),
        Frame(102, [65]),
        Frame(102, [65, 66]),
        Frame(102, [65, 66, 67, 68]),
        Frame(102, []),
        Frame(102, [255]),
        // TLS ClientHello shapes (first-byte 0x16 sniff path): plausible,
        // truncated, and bare-prefix forms.
        [0x16, 0x03, 0x01, 0x00, 0x2E, 0x01, 0x00, 0x00, 0x2A, 0x03, 0x03,
         0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x04,
         0x13, 0x01, 0x13, 0x02, 0x01, 0x00],
        [0x16, 0x03, 0x01, 0x00, 0x2E, 0x01],
        [0x16, 0x03],
        [0x16],
        Frame(24, [0, .. Ascii("MUDCLIENT")]),
        Frame(24, [0, .. Ascii("xterm")]),
        Frame(42, [1, .. Ascii(" utf-8")]),
        Frame(39, [0, 0, .. Ascii("SYSTEMTYPE"), 1, .. Ascii("MTTS 137")]),
        Frame(90, []),
        Frame(91, []),
