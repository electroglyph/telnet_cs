...
// Hermetic like RealSocketIntegrationTests: loopback only, OS-assigned
...
#pragma warning restore CA2000
      ...
      read.Should().Be(3);
      opening.Should().Equal((byte)255, (byte)253, (byte)3);
...
#pragma warning restore CA2000
  ...
  public class ServerSessionProtocolTests
  {
    ...
    public async Task SendOpeningPresetAsync_SendsExactPresetFrames()
    {
      ...
      OutboundBytes(stream).Should().Equal(
        ...
        (byte)255, (byte)253, (byte)32,
        (byte)255, (byte)253, (byte)31,
        (byte)255, (byte)253, (byte)36,
        (byte)255, (byte)253, (byte)34);
    }
    ...
    public async Task RequestEnableAsync_SendsDoOnce()
    {
      ...
      OutboundBytes(stream).Should().Equal((byte)255, (byte)253, (byte)24);
    }
    ...
    public async Task RequestDisableAsync_AfterPeerAgrees_SendsDont()
    {
      ...
      stream.ByteWrites[1].Should().Equal((byte)255, (byte)254, (byte)24);
    }
    ...
    public async Task SendCommand_SendsControlFrame(Commands command)
    {
      ...
      OutboundBytes(stream).Should().Equal((byte)255, (byte)command);
    }
  ...
  public class ServerSessionRequesterTests
  {
    ...
    public async Task RequestTerminalTypesAsync_CollectsChainUntilRepeat()
    {
      ...
      OutboundBytes(stream).Should().Equal((byte)255, (byte)250, (byte)24, (byte)1, (byte)255, (byte)240);
    }
    ...
    public async Task RequestTerminalSpeedAsync_NormalizesAnswer()
    {
      ...
      OutboundBytes(stream).Should().Equal((byte)255, (byte)250, (byte)32, (byte)1, (byte)255, (byte)240);
    }
    ...
    public async Task RequestEnvironmentAsync_ParsesRequestedEntries()
    {
      ...
      stream.Enqueue([255, 250, 36, 0,
        ...
        255, 240]);
      using var session = NewSession(stream);
      var env = await session.RequestEnvironmentAsync(TimeSpan.FromSeconds(5), [(byte)0, (byte)3]);
      env.Should().Contain("USER", "bob").And.Contain("ROLE", "ops");
      OutboundBytes(stream).Should().Equal(
        (byte)255, (byte)250, (byte)36, (byte)1, (byte)0, (byte)3, (byte)255, (byte)240);
    }
    ...
    public async Task StrayIs_WithoutOutstandingRequest_AnswersWont()
    {
      ...
      OutboundBytes(stream).Should().Equal((byte)255, (byte)252, (byte)24);
    }
  ...
  public class ServerSessionLinemodeTests
  {
    ...
    public async Task LmodeAgreement_CompletesWithoutFurtherReply()
    {
      ...
      OutboundBytes(stream).Should().Equal((byte)255, (byte)253, (byte)34);
    }
    ...
    public async Task ModeRequest_SubsetIsConfirmedWithRequiredBitsAndAck()
    {
      ...
      await session.ReadAsync(TimeSpan.FromSeconds(5));
      OutboundBytes(stream).Should().Equal(
        (byte)255, (byte)251, (byte)34,
        (byte)255, (byte)250, (byte)34, (byte)1, (byte)7, (byte)255, (byte)240);
    }
    ...
    public async Task ModeAck_DifferingMaskIsAdoptedSilently()
    {
      ...
      await session.ReadAsync(TimeSpan.FromSeconds(5));
      OutboundBytes(stream).Should().Equal((byte)255, (byte)251, (byte)34);
    }
    ...
    public async Task SendModeAsync_SendsExactFrameWhenAgreed()
    {
      ...
      OutboundBytes(stream).Should().Equal(
        (byte)255, (byte)253, (byte)34,
        (byte)255, (byte)250, (byte)34, (byte)1, (byte)3, (byte)255, (byte)240);
    }
    ...
    public async Task ForwardMask_RoundTrip()
    {
      ...
      OutboundBytes(stream).Should().Equal(
        (byte)255, (byte)253, (byte)34,
        (byte)255, (byte)250, (byte)34, (byte)253, (byte)2, (byte)255, (byte)255, (byte)255, (byte)240);
    }
    ...
    public async Task ForwardMask_RogueProposal_IsRefused()
    {
      ...
      OutboundBytes(stream).Should().Equal(
        (byte)255, (byte)251, (byte)34,
        (byte)255, (byte)250, (byte)34, (byte)252, (byte)2, (byte)255, (byte)240);
    }
    ...
    public async Task PublishSpecialCharactersAsync_SendsConfiguredTable()
    {
      ...
      OutboundBytes(stream).Should().Equal(
        (byte)255, (byte)253, (byte)34,
        (byte)255, (byte)250, (byte)34, (byte)3, (byte)3, (byte)2, (byte)5, (byte)255, (byte)240);
    }
    ...
    public async Task RequestRemoteSpecialCharactersAsync_SendsImportFrame()
    {
      ...
      OutboundBytes(stream).Should().Equal(
        (byte)255, (byte)253, (byte)34,
        (byte)255, (byte)250, (byte)34, (byte)3, (byte)0, (byte)3, (byte)0, (byte)255, (byte)240);
    }
    ...
    public async Task InboundSlcTable_IsFoldedAndAnswered()
    {
      ...
      OutboundBytes(stream).Should().Equal(
        (byte)255, (byte)251, (byte)34,
        (byte)255, (byte)250, (byte)34, (byte)3, (byte)3, (byte)130, (byte)5, (byte)255, (byte)240);
    }
    ...
    public async Task StatusSend_AnsweredFromSessionState()
    {
      ...
      outbound.Skip(21).Should().Equal(
        (byte)255, (byte)250, (byte)5, (byte)0,
        (byte)251, (byte)1, (byte)251, (byte)3,
        (byte)253, (byte)24, (byte)253, (byte)31, (byte)253, (byte)32, (byte)253, (byte)34, (byte)253, (byte)36,
        (byte)240);
    }
    ...
    public async Task TimingMarkDo_AnsweredWill()
    {
      ...
      await session.ReadAsync(TimeSpan.FromSeconds(5));
      OutboundBytes(stream).Should().Equal((byte)255, (byte)251, (byte)6);
    }
  }
}
